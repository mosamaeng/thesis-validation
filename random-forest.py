...
# Fit the imputer on the train data and transform both train and random data
X_train = imputer.fit_transform(X_train)
X_test = imputer.transform(random_df)
...
print(f"RF Accuracy on random data: {accuracy}")
